...
#ifndef HW_MINI407VE_H_
#define HW_MINI407VE_H_

#define HW_NAME					"mini407ve"

// HW properties
#define HW_USE_25M_XTAL
...
#define LED_GREEN_ON()			palSetPad(GPIOB, 9)
#define LED_GREEN_OFF()			palClearPad(GPIOB, 9)
