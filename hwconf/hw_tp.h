...
#define ADC_IND_EXT				13
#define ADC_IND_EXT2			6
#define ADC_IND_TEMP_MOS1		11
#define ADC_IND_TEMP_MOS2		7
#define ADC_IND_TEMP_MOS3		8
...
#define NTC_TEMP(adc_ind)		hwtp_get_temp()

#define NTC_RES_MOTOR(adc_val)	(10000.0 / ((4095.0 / (float)adc_val) - 1.0)) // Motor temp sensor on low side
#define NTC_TEMP_MOTOR(beta)	12.0//(1.0 / ((logf(NTC_RES_MOTOR(ADC_Value[ADC_IND_TEMP_MOTOR]) / 10000.0) / beta) + (1.0 / 298.15)) - 273.15)
...
#define HW_ENC_TIM_CLK_EN()		LL_APB1_GRP1_EnableClock(LL_APB1_GRP1_PERIPH_TIM4)
#define HW_ENC_EXTI_PORTSRC		LL_SYSCFG_EXTI_PORTC
#define HW_ENC_EXTI_PINSRC		LL_SYSCFG_EXTI_LINE11
#define HW_ENC_EXTI_CH			EXTI15_10_IRQn
#define HW_ENC_EXTI_LINE		LL_EXTI_LINE_11
